...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def show_image(self, index:int):
        ...
        try:
            ...
            self.scene.p_start_time = time.time()
            ...
            if self.can_be_annotated:
                ...
                for object in self.current_label.objects:
                    ...
                    # update progress
                    self.scene.update_progress(polygon.points, 255, False)
                if len(self.current_label.objects) == 0:
                    self.info_dock_widget.progressBar.reset()
