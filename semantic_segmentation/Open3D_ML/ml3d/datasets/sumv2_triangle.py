...
COLOR_MAP = np.asarray(
    [
        ...
        [170, 85, 0],    #label 1 terrain
        [0, 255, 0],     #label 2 high_vegetation
        [255, 255, 0],   #label 3 facade_surface
        [0, 255, 255],   #label 4 water
        [255, 0, 255],   #label 5 car
        [0, 0, 153],     #label 6 boat
        [85, 85, 127],   #label 7 roof_surface
        [255, 50, 50],   #label 8 chimney
        [85, 0, 127 ],   #label 9 dormer
        [50, 125, 150],  #label 10 balcony
        [50, 0, 50],     #label 11 building_part
		[215, 160, 140]  #label 12 wall
    ]
)
...
class sumv2_triangle_Split(BaseDatasetSplit):
...
class sumv2_triangle(BaseDataset):
    ...
    def get_split(self, split):
        ...
        Returns:
            A dataset split object providing the requested subset of the data.
        """
        return sumv2_triangle_Split(self, split=split)
...
DATASET._register_module(sumv2_triangle)
