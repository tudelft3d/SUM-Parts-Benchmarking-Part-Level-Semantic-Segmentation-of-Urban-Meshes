...
def main():
    ...
    ####################Change param##########################change for train(10) or testing(-1)
    ...
    parser.add_argument('--odir', default='../datasets/sumv2_tri_demo/results', help='Directory to store results')
    ...
    parser.add_argument('--CUSTOM_SET_PATH', default='../datasets/sumv2_tri_demo')

    # Model
    ####################Change param##########################default='gru_10,f_10', 10 classes
    # Model,gru_10, f_class, be careful
    parser.add_argument('--model_config', default='gru_10,f_12',
    ...
    ####################################################default='delta_avg,delta_std,nlength/ld,surface/ld,volume/ld,size/ld,xyz/d'
    ...
    parser.add_argument('--pc_attribs', default='xyzrgbelpsv', help='Point attributes fed to PointNets, if empty then all possible. xyz = coordinates, rgb = color, e = elevation, lpsv = geometric feature, d = distance to center')
