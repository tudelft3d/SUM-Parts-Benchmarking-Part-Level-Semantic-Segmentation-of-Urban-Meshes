...
parser.add_argument('--ROOT_PATH', default='../datasets/sumv2_tri_demo')
...
####################Change param########################## default=0.03
parser.add_argument('--voxel_width', default=0.1, type=float, help='voxel size when subsampling (in m)')
...
for folder in folders:
    ...
    for file in files:
        ...
        if os.path.isfile(fea_file) and not args.overwrite:
            ...
            start = timer()
            #---compute 10 nn graph-------compute_sp_graph
