...
parser.add_argument('--ROOT_PATH', default='../datasets/custom_set2', help='folder containing the ./data folder')
parser.add_argument('--res_file', default='../datasets/custom_set2/results/predictions_test', help='folder containing the results')
...
parser.add_argument('--upsample', default=1, type=int, help='if 1, upsample the prediction to the original cloud (if the files is huge it can take a very long and use a lot of memory - avoid on sema3d)')
parser.add_argument('--ver_batch', default=0, type=int, help='Batch size for reading large files')

####################Change param########################## default='igfpres'
...
if args.dataset == 'sema3d':
    n_labels = 8   
if args.dataset == 'custom_dataset2':
    n_labels = 6
#---load the values------------------------------------------------------------
